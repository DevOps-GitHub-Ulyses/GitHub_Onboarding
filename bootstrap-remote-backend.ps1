...
$location                 = 'westus2'
$tfbackend_rg_name        = 'GitHubtfstate'
$tfbackend_sa_name        = 'githubulramos' # 3-24 chars, lowercase letters, numbers, only
$tfbackend_container_name = 'tfstate'
$tf_sp_name               = 'DevOps-Onboarding-Ulramos'
$ghUsername               = 'ulysesramos'
$ghPAT                    = '' # Pass in your GitHub Personal Access Token with repo & org access premissions
$ghOrgName                = 'DevOps-Onboarding-Ulyses'
$ghRepoName               = 'GitHub_Onboarding'
$ghRepoEnvironmentName    = 'Azure-Dev'
